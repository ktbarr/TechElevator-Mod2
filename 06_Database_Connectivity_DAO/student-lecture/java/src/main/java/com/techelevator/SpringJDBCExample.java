...
public class SpringJDBCExample {
	...
	public static void main(String[] args) {
		 ...
		 * Any following parameters are used to replace query place holders (i.e. '?') in the order in which they appear */
		...
		// 4. update() - when modifying data. INSERT, UPDATE, DELETE
