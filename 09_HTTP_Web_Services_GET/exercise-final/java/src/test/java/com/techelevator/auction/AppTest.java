...
public class AppTest {
        ...
        public void listAllAuctions() {
        	// Arrange
            when(mockRestTemplate.getForObject(eq(App.API_URL), eq(Auction[].class)))
            	.thenReturn(expectedAuctions);
            app.restTemplate = mockRestTemplate;

            // Act
            Auction[] actualAuctions = app.listAllAuctions();

            // Assert
            assertEquals("App.API_URL is not valid. Must be '" + EXPECTED_API_URL + "'", EXPECTED_API_URL, App.API_URL);
        ...
        public void listDetailsForAuction() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(App.API_URL + "/1"), eq(Auction.class)))
        		.thenReturn(expectedAuction);
            app.restTemplate = mockRestTemplate;

            // Act
            Auction actualAuction = app.listDetailsForAuction(1);
        ...
        public void findAuctionsSearchTitle() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(App.API_URL + "?title_like=Zero"), eq(Auction[].class)))
        		.thenReturn(expectedAuctions);
            app.restTemplate = mockRestTemplate;

            // Act
            Auction[] actualAuctions = app.findAuctionsSearchTitle("Zero");
        ...
        public void findAuctionsSearchTitleNotFound() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(App.API_URL + "?title_like=NoSuchTitle"), eq(Auction[].class)))
        		.thenReturn(new Auction[0]);
            app.restTemplate = mockRestTemplate;

            // Act
            Auction[] actualAuctions = app.findAuctionsSearchTitle("NoSuchTitle");
        ...
        public void findAuctionsSearchPrice() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(App.API_URL + "?currentBid_lte=23.25"), eq(Auction[].class)))
        		.thenReturn(expectedAuctions);
            app.restTemplate = mockRestTemplate;

            // Act
            Auction[] actualAuctions = app.findAuctionsSearchPrice(23.25);
        ...
        public void findAuctionsSearchPriceNotFound() {
        	// Arrange
        	when(mockRestTemplate.getForObject(eq(App.API_URL + "?currentBid_lte=0.0"), eq(Auction[].class)))
        		.thenReturn(new Auction[0]);
            app.restTemplate = mockRestTemplate;

            // Act
            Auction[] actualAuctions = app.findAuctionsSearchPrice(0.0);
