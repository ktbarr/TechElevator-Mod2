...
public class PasswordHasher
{
    ...
    /**
     * Given a clear text password and a salt, hash the password and return the
     * computed hash.
     *
    ...
    /**
     * This is the function that actually generates the hash. You can see that it
     * uses a work factor to generate the hash. The work factor should be high
     * enough that it's painful for attackers, but not for users. A good half second
     * to one second delay should be plenty.
     *
